...
function MainScript() {
var components = this.window.components = {};
alert("fkzdf;dzskf")
...
components.linearicons = {
	...
	styles: '../linearicons/linearicons.css'
};
...
components.button = {
	selector: '.btn',
	styles: '../button/button.css'
};

components.blogPost = {
	selector: '.blog-post',
	styles: '../blog-post/blog-post.css'
};

components.blurb = {
	selector: '.blurb',
	styles: '../blurb/blurb.css'
};
...
components.partner = {
	selector: '.partner',
	styles: '../partner/partner.css'
};

components.bradcrumb = {
	selector: '.breadcrumb',
	styles: '../breadcrumb/breadcrumb.css'
};

components.checkboxTag = {
	selector: '.checkbox-tag',
	styles: '../checkbox-tag/checkbox-tag.css'
};

components.circle = {
	selector: '.circle',
	styles: '../circle/circle.css'
};

components.comment = {
	selector: '.comment',
	styles: '../comment/comment.css'
};

components.divider = {
	selector: '.divider',
	styles: '../divider/divider.css'
};
...
components.grid = {
	...
	styles: '../grid/grid.css'
};

components.icon = {
	selector: '.icon',
	styles: '../icon/icon.css'
};
...
components.logo = {
	selector: '.logo',
	styles: '../logo/logo.css'
};

components.rdForm = {
	selector: '.rd-form',
	styles: '../rd-form/rd-form.css'
};

components.rights = {
	selector: '.rights',
	styles: '../rights/rights.css'
};
...
components.post = {
	selector: '.post',
	styles: '../post/post.css'
};

components.postMeta = {
	selector: '.post-meta',
	styles: '../post-meta/post-meta.css'
};
...
components.quote = {
	selector: '.quote',
	styles: '../quote/quote.css'
};

components.rating = {
	selector: '.rating',
	styles: '../rating/rating.css'
};
...
components.snackbar = {
	selector: '.snackbar',
	styles: '../snackbar/snackbar.css'
};

components.social = {
	selector: '.social',
	styles: '../social/social.css'
};
...
components.templateInfo = {
	...
	styles: '../template-info/template-info.css'
};

components.table = {
	selector: '.table',
	styles: '../table/table.css'
};
...
components.termList = {
	selector: '.term-list',
	styles: '../term-list/term-list.css'
};

components.textBlock = {
	selector: '.text-block',
	styles: '../text-block/text-block.css'
};

components.thumbnail = {
	selector: '.thumbnail',
	styles: '../thumbnail/thumbnail.css'
};

components.video = {
	selector: '.video',
	styles: '../video/video.css'
};

components.widget = {
	selector: '.widget',
	styles: '../widget/widget.css'
};
...
components.accordion = {
	...
	styles: [
		...
		'../linearicons/linearicons.css'
	]
};

components.campaignMonitor = {
	selector: '.campaign-mailform',
	styles: '../rd-mailform/rd-mailform.css',
...
components.counter = {
	...
	styles: '../counter/counter.css',
	script: [
		'../util/util.min.js',
		'../counter/counter.min.js',
	],
	init: function ( nodes ) {
		let observer = new IntersectionObserver( function ( entries ) {
			let observer = this;
...
components.swiper = {
	...
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			...
			if (params.paginationNumbered === true) {
				pagination = {
					type: 'bullets',
